...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{$langCode}" xml:lang="{$langCode}" dir="ltr">
    <head>
        ...
        //<![CDATA[
            ...
            var gAddressupdated = "{/literal}{$addressupdated}{literal}";
        ...
        {/literal}{/if}{literal}
            ...
            */
            ...
            function my_addtoany_onshare(pData)
            {
                if (!checkPassword())
                {
                    createDialog("{/literal}{#str_TitleWarning#}{literal}", "{/literal}{#str_MessagePasswordInformation#}{literal}", function(e) {
                        closeDialog(e);
                    });
                        ...
                        switch (obj)
                        {
                            case 'verifyPassword':
                                try {
                                    ...
                                    showVerificationFailedMessageSmallScreen("{/literal}{#str_ErrorLoginHasExpired#}{literal}", handleSessionExpirySmallScreen);
                                    break;
                                }
                            case 'addressForm':
                            ...
                            case 'renameonlineproject':
                                try
                                {
                                    ...
                                    if (jsonObject.error == '')
                                    {
                                        ...
                                        {
                                            closeLoadingDialog();
                                            createDialog("{/literal}{#str_TitleWarning#}{literal}", "{/literal}{#str_ErrorMaintenanceMode#}{literal}", function(e) {
                                                closeDialog(e);
                                            });
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                closeLoadingDialog();
                                                createDialog("{/literal}{#str_TitleWarning#}{literal}", projectDetails.nameexists, function(e) {
                                                    closeDialog(e);
                                                });
                                            }
                                            else
                            ...
                            case 'getshareonlineprojecturl':
                                try
                                {
                                    ...
                                    showOPActionPanel(true, {
                                        ...
                                        label: '{/literal}{#str_LabelShareLink#}{literal}',
                                        labelBtn: '{/literal}{#str_ButtonCopyLink#}{literal}',
                                        value: shareURL,
                                        fn: function(){
                                ...
                                try
                                {
                                    ...
                                    if (error == '')
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                closeLoadingDialog();
                                                createDialog("{/literal}{#str_TitleWarning#}{literal}", nameExistsError, function(e) {
                                                    closeDialog(e);
                                                });
                                            }
                                            else
                            ...
                            case 'openonlineproject':
                                ...
                                else
                                {
                                    ...
                                    {
                                        closeLoadingDialog();
                                        createDialog("{/literal}{#str_TitleError#}{literal}", resultMessage, function(e) {
                                            closeDialog(e);
                                        });
                                    }
                                }
                            ...
                            case 'completeorder':
                                ...
                                else
                                {
                                    ...
                                    {
                                        closeLoadingDialog();
                                        createDialog("{/literal}{#str_TitleError#}{literal}", response.errorparam, function(e) {
                                            closeDialog(e);
                                        });
                                    }
                                }
                            ...
                            case 'unshare':
                                try
                                {
                                   ...
                                   if (unshareResult['success'])
                                   {
                                       ...
                                       {
                                           message = "{/literal}{#str_SuccessUnshare#}{literal}";
                                           if (unshareObjLink)
                                           {
                                   ...
                                   {
                                       message = "{/literal}{#str_ErrorConnectFailure#}{literal}";
                                   }
                            ...
                            case 'redeemgiftcard':
                                try
                                {
                                	...
                                	{
                                		showLoadingNotificationBar('{/literal}{#str_LabelGiftCardAccepted#}{literal}');
                                		showPanelAccount(false, '');
                                	}
                                }
                                catch (e)
                            ...
                            case 'menuAjaxAction':
                                try
                                {
                                	...
                                	// change javascript
                                	toggleJs('mainjavascript', jsonObj.javascript, true, '', '{/literal}{$nonceraw}{literal}');
                            ...
                            case 'updateAction':
                                try
                                {
                                	...
                                	{
                                		createDialog("{/literal}{#str_TitleWarning#}{literal}", jsonObj.message, function(e) {
                                		    closeDialog(e);
                                        });
                                	}
            ...
            */
            ...
            function showPreview(pAddress)
            {
				...
				// use JSONP
				toggleJs('previewlink', '', true, encodeURI(pAddress) + '&callback=showPreviewCallBack', '{/literal}{$nonceraw}{literal}', '', undefined, true);
				...
				try
				{
					...
					if (jsonObj.javascript != '')
					{
						...
						if ((jsonObj.scripturl1 != '') && (jsonObj.scripturl2 != '') && (! contentCustomScript))
						{
							...
							var callBackScript = 'toggleJs("externalscript1", "", true, "' + jsonObj.scripturl2 + '", "{/literal}{$nonceraw}{literal}", \'toggleJs("mainjavascript", \"' + mainScript + '\", true, "", "{/literal}{$nonceraw}{literal}"); initPreview(true); showOrderPreview(true, true);\');';
							toggleJs('externalscript', '', true, jsonObj.scripturl1, '{/literal}{$nonceraw}{literal}', callBackScript);
						}
						else
						{
            ...
            function verifyAccountSmallScreen()
            {
                ...
                if (passwordObj)
                {
                    ...
                    {
                        closeDialog();
                        showVerificationFailedMessageSmallScreen("{/literal}{#str_ErrorNoPassword#}{literal}", function(e) {
                            closeDialog(e);
                        });
                    }
                }
            ...
            function showVerificationFailedMessageSmallScreen(message, callback)
            {
                ...
                createDialog("{/literal}{#str_TitleError#}{literal}", "<p>" + message + "</p>", callback);
            }
            ...
            function showVerifyPassword(event)
            {
                if (!eventStack.length)
                {
                    ...
                    label.innerText = "{/literal}{#str_LabelRenterPassword#}{literal}:";
                    ...
                    createDialog("{/literal}{#str_TitleConfirmChanges#}{literal}", container.outerHTML, verifyAccountSmallScreen);
    ...
    <body>
                    ...
                    <div id="contentLeftScrollMenu" class="contentScrollCart">
                        ...
                        <div class="contentVisible">
                            ...
                            {if $hasflaggedonlineprojects}
                                <div id="flaggedForPurge" class="warning-bar">{#str_MessageMainPurgeWarning#} <a href="#" data-decorator="fnVisitCheckProjects" data-link="{$checkprojectslink}" data-internal="{$hasonlinedesignerurl}">{#str_TitlePurgeWarningLink#}</a></div>
                            {/if}
                                    ...
                                    <div class="content contentMenu" id="content">
                                        ...
                                        <div class="outerBox outerBoxPadding">
                                            ...
                                            <div class="menuItem menuItemYourOrder" data-decorator="fnMenuAction" data-url="Customer.yourOrders" data-action="yourorders">
                                                <img class="iconAction" src="{$brandroot}/images/icons/account/icon-your-orders.png" alt="" /><br />
                                                <div class="menuText">
                                                    {#str_MenuTitleYourOrders#}
                                                </div>
                                                <img class="nextImage" src="{$webroot}/images/icons/account/account-panel-arrow_v2.png" alt=">" />
                                                <div class="clear"></div>
                                            </div>
        ...
        {if $hasonlinedesignerurl == 1}
                                            <div class="menuItem menuItemOnlineProject" data-decorator="fnMenuAction" data-url="Customer.displayOnlineProjectList" data-action="onlineProject">
                                                <img class="iconAction" src="{$brandroot}/images/icons/account/icon-online-projects.png" alt=""><br>
                                                <div class="menuText">
        ...
        {/if} {* end {if $hasonlinedesignerurl == 1} *}
        ...
        {if $canmodifyaccountdetails == 1}
                                            ...
                                            <div class="menuItem menuItemAccountDetails" data-decorator="fnMenuAction" data-url="Customer.accountDetails" data-action="accountDetails">
                                                <img class="iconAction" src="{$brandroot}/images/icons/account/icon-account-details.png" alt="" /><br />
                                                <div class="menuText">
        ...
        {/if} {* end {if $canmodifyaccountdetails == 1} *}
        ...
        {if $canmodifypassword == 1}
                                            ...
                                            <div class="menuItem menuItemChangePassword" data-decorator="fnMenuAction" data-url="Customer.changePassword" data-action="changePassword">
                                                <img class="iconAction" src="{$brandroot}/images/icons/account/icon-change-password.png" alt="" /><br />
                                                <div class="menuText">
        ...
        {/if} {*end {if $canmodifypassword==1} *}
                                            ...
                                            <div class="menuItem menuItemLast menuItemChangePreferences" data-decorator="fnMenuAction" data-url="Customer.changePreferences" data-action="changePreferences">
                                                <img class="iconAction" src="{$brandroot}/images/icons/account/icon-change-preferences.png" alt="" /><br />
                                                <div class="menuText">
        ...
        {/if} {* end {if $showaccountbalance == true} *}
        ...
        {if $redactionmode >= 2}
                                        ...
                                        <div class="outerBox outerBoxMarginTop">
                                            ...
                                            <div class="outerBoxPadding">
                                                ...
                                                <div class="titleAccountBloc">
                                                    {#str_LabelDataDeletion#}
                                                </div>

                                                <div class="descriptionAccountBloc">
                                                    {#str_MessageLoginToLargeScreenToRequestDataDeletion#}
                                                </div>

                                            </div>

                                        </div>
        {/if} {* end {if $redactionmode >= 2} *}
                        ...
                        <div class="contentVisible">
                            ...
                            <div class="outerBox outerBoxPadding">
                                ...
                                <div>
                                    ...
                                    <div class="formLine1">
                                        <label for="giftcardid">{#str_LabelGiftCardRedeemText#}</label>
                                    </div>

                                    <div class="formLine2">
                                        <input type="text" id="giftcardid" class="inputGiftCard" name="giftcardid" placeholder="{#str_LabelEnterCode#}" data-decorator="fnInputGiftCard" data-trigger="keyup"/>
                                    </div>
                            ...
                            <div class="paddingBtnBottomPage">
                                <div class="btnAction btnContinue" data-decorator="fnRedeemGiftCard">
                                    <div class="btnContinueContent">{#str_LabelRedeem#}</div>
                                </div>
                            </div>
                                ...
                                <div class="passwordBloc">
                                    ...
                                    <div class="passwordHeader outerBoxPadding">
                                        ...
                                        <div class="passwordLabel">
                                            {#str_LabelPasswordProtection#}
                                        </div>

                                        <div class="passwordButton">

                                            <div class="onOffSwitch">
                                                <input type="checkbox" id="sharepassword" class="onOffSwitchCheckbox" name="onOffSwitch" data-decorator="fnPasswordDisplay" {if $checkbox.checked}checked="checked"{/if} />
                                ...
                                <div id="passwordForm" class="passwordForm toggleDiv">
                                    ...
                                    <div>
                                        <div class="formLine1">
                                            ...
                                            <img id="previewPasswordcompulsory2" class="imgFloat" src="{$brandroot}/images/asterisk.png" alt="*"/>
                                            <div class="clear"></div>
                                        </div>
    ...
    {/if} {* end {if $sharebyemailmethod > 0}*}
                    ...
                    <div id="contentRightScrollShareDetail" class="contentScrollCart">
                        ...
                        <div class="contentVisible">
                            ...
                            <div id="shareSocial">
                                ...
                                <div class="pageLabel">
                                    {#str_TitleShareViaSocialNewtworks#}
                                </div>
        ...
        {if $sharebyemailmethod == 1}
                                    ...
                                    <div class="top_gap">
                                        ...
                                        <div class="formLine2">
                                            ...
                                            <img id="shareByEmailTocompulsory" class="error_form_image" src="{$brandroot}/images/asterisk.png" alt="*"/>
                                            <div class="clear"></div>
                                        </div>
        ...
        {else} {* else {if $sharebyemailmethod == 1} *}
        ...
        {/if} {* end {if $sharebyemailmethod == 1} *}
                                ...
                                <div class="paddingBtnBottomPage">
                                    ...
                                    <div class="btnAction btnContinue" id="shareByEmailBtn" data-decorator="fnShareByEmail">
                                        <div class="btnContinueContent">{#str_LabelShare#}</div>
                                    </div>
