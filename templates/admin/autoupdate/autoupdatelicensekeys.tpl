...
{
	{/literal}
	var licenceUpdateTitle = "{#str_AutoUpdateTitleLicenseKeys#}";
	var licenceCodeTitle_tx = "{#str_LabelCode#}";
	var licenceNameTitle_tx = "{#str_LabelName#}";
	var licenceFilenameTitle_tx = "{#str_LabelFileName#}";
	var licenceVersionTitle_tx = "{#str_LabelVersion#}";
	var licenceBrandingTitle_tx = "{#str_SectionTitleBranding#}";
	var licenceCurrencyTitle_tx = "{#str_LabelCurrencyCode#}";
	var licenceActiveTitle_tx = "{#str_LabelActive#}";
	var savingLabel_txt = "{#str_MessageSaving#}";
	var addLabel_txt = "{#str_ButtonEdit#}";
	var buttonDelete_txt = "{#str_LabelRemove#}";
	var delteLabel_txt = "{#str_LabelConfirmation#}";
	var delteConformation_txt = "{#str_DeleteLicenseKeyConfirmation#}";
	...
	var savingLabel_txt = "{#str_MessageSaving#}";
	var licenseKeyUsed_txt = "{#str_WarningUsedLicenseKey#}";
	var deleteContinue_txt = "{#str_WarningContinue#}";
	var deleteSuccess_txt = "{#str_DeleteLicenseKey#}";
	var errorLabel_txt = "{#str_TitleError#}";
	var addressVerificationFailedLabel_txt = "{#str_LabelAddressVerificationFailed#}";
	var statusLabel_txt = "{#str_LabelStatus#}";
	var errorConnectLabel_txt = "{#str_ErrorConnectFailure#}";
	var enableGroupingLabel_txt = "{#str_LabelEnableGrouping#}";
	var activeLabel_tx ="{#str_LabelActive#}"; 
	var enabledLabel_tx = "{#str_LabelEnabled#}";
	var disabledLabel_tx = "{#str_LabelDisabled#}";
	var inactivelabel_tx = "{#str_LabelInactive#}";
	var editLabel_txt = "{#str_TitleEditLicenseKey#}";
	...
	var telephoneTitle_tx ="{#str_LabelTelephoneNumber#}";
	var emailTitle_tx ="{#str_LabelEmailAddress#}";
	var retypeemailTitle_tx ="{#str_LabelRetypeEmailAddress#}";
	...
	{ 
		...
		if (!licenseKeyEditWindowExists)
		{
			...
			Ext.taopix.loadJavascript(gMainWindowObj, '', 'index.php?fsaction=AdminAutoUpdate.editLicenseKeyDisplay&ref={/literal}{$ref}{literal}', serverParams, '', 'initialize', false);
		}
	};
	...
	grid = new Ext.grid.GridPanel({
		...
		plugins: [new Ext.ux.grid.Search({
			...
			minChars: 3,
			width: 200,
			disableIndexes:['status','priority','id','canDelete','version','currencycode','active','company'{/literal}{if $optiondesol == true}{literal},'availableonline'{/literal}{/if}{literal}],
			autoFocus: true
		})],        
