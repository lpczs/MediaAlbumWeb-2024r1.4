...
function initialize(pParams)
{
	...
	{
		var submitURL = 'index.php?fsaction=AdminComponentsPricing.add&ref={/literal}{$ref}{literal}';
		var fp = Ext.getCmp('componentsPricingForm'), form = fp.getForm();
		var submit = true;
	...
	function editPricingSaveHandler(btn, ev)
	{
		...
		var submitURL = 'index.php?fsaction=AdminComponentsPricing.edit&ref={/literal}{$ref}{literal}&id=' + selectID;
		var fp = Ext.getCmp('componentsPricingForm'), form = fp.getForm();
		var submit = true;
	...
	{/literal}{if ($pricingmodel == 5) || ($pricingmodel == 7) ||  ($pricingmodel == 8)}{literal}
		var windowWidth = 980;
	{/literal}{else}{literal}
		var windowWidth = 700;
	{/literal}{/if}{literal}
	...
	var newPricingTaopixPanel =
    {
        ...
        pricing:{pricingModel: '{/literal}{$pricingmodel}{literal}', price:'{/literal}{$price}{literal}', isPriceList:'{/literal}{$ispricelist}{literal}', priceListID: '{/literal}{$pricelistid}{literal}', qtyIsDropDown: '{/literal}{$quantityisdropdown}{literal}', taxCode: '{/literal}{$taxcode}{literal}', productType: '0'},
        licenseKeyStoreURL: 'index.php?fsaction=AdminComponentsPricing.getLicenseKeyFromCompany&ref={/literal}{$ref}{literal}&componentcode={/literal}{$componentcode}{literal}&id={/literal}{$parentid}{literal}&companycode={/literal}{$companycode}{literal}',
        LicenseKeys: {assignedLicenseKeys: assignedKeys, defaultChecked: '{/literal}{$defaultChecked}{literal}'},
        {/literal}{if $id > 0}{literal}
	...
	var dialogPricingFormPanelObj = new Ext.taopix.FormPanel({
		...
		items: [
			...
			{ xtype: 'panel', id: 'topPanel', layout: 'column',style:'background:#c9d8ed; padding: 3px 0; border:1px solid #8ca9cf; margin-bottom:7px;', columns: 2, plain:true, bodyBorder: false,
