...
<div id="contentRightScrollOrderFooterComponentDetail" class="contentScrollCart">
    ...
    {if $stage == 'qty'}
        ...
        {foreach from=$orderfootersections item=section} {* sections *}
       ...
       <div id="componentDetail_{$section.orderlineid}" class="componentDetail">
            ...
            <div class="outerBox">
                    ...
                    <div id="componentContentDetail_{$section.orderlineid}">
                        ...
                        <div class="itemSection outerBoxPadding">
                            ...
                            {if empty($section.itemqtydropdown)}
                                    ...
                                    <input id="itemqty_{$section.orderlineid}" type="number" class="quantityInput" maxlength="8" value="{$section.quantity}" data-decorator="fnUpdateComponentQty" data-trigger="keyup" data-lineid="{$section.orderlineid}" data-itemqty="{$section.itemqty}" />
                                    <img class="refresh" src="{$brandroot}/images/icons/refresh.png" alt="{#str_LabelOrderUpdateItemTotal#}" title="{#str_LabelOrderUpdateItemTotal#}" data-decorator="fnUpdateComponentQty" data-trigger="click" data-lineid="{$section.orderlineid}" data-itemqty="{$section.itemqty}" />
                                    <div class="clear"></div>
                ...
                <div class="contentChangeBtn outerBoxPadding" data-decorator="fnChangeComponent" data-orderlineid="-1" data-sectionlineid="{$section.orderlineid}">
            ...
            <div class="contenSubComponent">
                ...
                <div id="componentContent_{$section.orderlineid}_{$subsection.orderlineid}" class="contentSubComponentBloc outerBox outerBoxMarginBottom outerBoxMarginTop">
                    ...
                    <div id="componentContent_{$subsection.orderlineid}">
                        ...
                        <div class="contentChangeBtn outerBoxPadding" data-decorator="fnSetHashUrl" data-hash-url="subComponentView|-1|{$section.orderlineid}|{$subsection.orderlineid}">
                            <div class="changeBtnText">
                                {#str_LabelOptionsAndExtras#}
                ...
                <div id="componentContent_{$section.orderlineid}_{$checkbox.orderlineid}" class="contentSubComponentBloc outerBox outerBoxMarginBottom outerBoxMarginTop">
                    ...
                    <div id="componentContent_{$checkbox.orderlineid}" class="componentBloc outerBoxPadding">
                    ...
                    <div class="contentChangeBtn outerBoxPadding" data-decorator="fnSetHashUrl" data-hash-url="subComponentView|-1|{$section.orderlineid}|{$checkbox.orderlineid}">
                        <div class="changeBtnText">
                            {#str_LabelOptionsAndExtras#}
                ...
                {/if} {* end {if ($section.subsections|@sizeof > 0) || ($section.checkboxes|@sizeof > 0)} *}
                    ...
                    {/if} {* end {if (($section.pricingmodel == 7) || ($section.pricingmodel == 8)) || ($section.subsections|@sizeof > 0)
                        || ($section.itemcomponentbuttons|@sizeof > 0) || ($subsection.metadatahtml) || ($section.checkboxes|@sizeof > 0)} *}
        ...
        <div id="componentDetail_{$checkbox.orderlineid}" class="componentDetail">
            ...
            <div class="outerBox">
                ...
                <div>
                    ...
                    <div id="componentContentDetail_{$checkbox.orderlineid}">
