...
// shipping
                        case '#shipping':
                            ...
                            if (typeof gCollectFromStoreCode !== 'undefined')
                            {
                                ...
                                {
                                    createDialog("{/literal}{#str_TitleConfirmation#}{literal}", "{/literal}{#str_ErrorNoStore#}{literal}", function(e) {
                                        closeDialog(e);
                                    });
...
// payment
                ...
                */
                ...
                function forceRedirectionToLogin(pMessage)
                {
                    if (pMessage != '')
                    {
                        createDialog("{/literal}{#str_TitleWarning#}{literal}", pMessage, function(e) {
                            redirectToLogin();
                        });
                    }
                    else
                ...
                function redirectToLogin()
                {
					...
					if (currentUrl == "{/literal}{$redirecturl}{literal}")
					{
					...
					{
						window.location.href = "{/literal}{$redirecturl}{literal}";
					}
                }
                        ...
                        if ((xmlhttp.readyState == 4) && (xmlhttp.status == 200))
                        {
                            switch (obj)
                            {
                                ...
                                case 'storeLocatorForm':
                                    ...
                                    toggleJs('includeSelectStoreJS', jsonObj.javascript, true, '', '{/literal}{$nonceraw}{literal}');
                                ...
                                case 'updateCheckBox':
                                    ...
                                    {
                                        createDialog("{/literal}{#str_TitleConfirmation#}{literal}", response.vouchermessage, function(e) {
                                            closeDialog(e);
                                        });
                                    }
                                ...
                                case 'showPayment':
                                    ...
                                    if (jsonObj.result == true)
                                    {
                                        ...
                                        {                                            
                                            ...
                                            if (scriptURL !== '')
                                            {
                                                toggleJs('externalscript_' + paymentmethodCode, '', true, scriptURL, '{/literal}{$nonceraw}{literal}', script, integrity);
                                            }

                                            if ((script !== '') && (scriptURL === ''))
                                            {
                                                toggleJs('paymentjavascript_' + paymentmethodCode, script, true, '', '{/literal}{$nonceraw}{literal}');
                                            }
											...
											{
												toggleJs('requestparamsremotelyjavascript_' + paymentmethodCode, 'gRequestPaymentParamsRemotely = true;', true, '', '{/literal}{$nonceraw}{literal}');
											}
                                        }
                                ...
                                case 'changeShippingAddressDisplay':
                                    ...
                                    // copy javascript content
                                    toggleJs('includeUpdateAddressJS', jsonObj.javascript, true, '', '{/literal}{$nonceraw}{literal}');
                                ...
                                case 'updateorderqtyall':
                                    ...
                                    for (i = 0; i < count; i++)
                                    {
                                        ...
                                        {
                                            createDialog("{/literal}{#str_TitleConfirmation#}{literal}", datas[i].vouchermessage, function(e) {
                                                closeDialog(e);
                                            });
                                        }
                                    }
                    ...
                    else
                    {
                        switch(gActivePanel)
                        {
                            ...
                            case 'contentPanelSelectStore':
                                ...
                                toggleJs('includeSelectStoreJS', '', false, '', '{/literal}{$nonceraw}{literal}');
                            ...
                            case 'contentPanelUpdateAddress':
                                ...
                                toggleJs('includeUpdateAddressJS', '', false, '', '{/literal}{$nonceraw}{literal}');
				...
				*/
				function orderButtonCompleteOrder()
				{
					...
					if (tsandcsCheckBox)
					{
						...
						if (! tsandcsCheckBox.checked)
						{
                            ...
                            createDialog("{/literal}{#str_TitleWarning#}{literal}", "{/literal}{#str_ErrorAcceptTermsAndConditions#}{literal}", function(e) {
                                closeDialog(e);
                            });
                ...
                function showHideComponents(pElementId, pIsFooter)
                {
                    ...
                    if (objElement.style.display == 'none')
                    {
                        ...
                        if (pIsFooter)
                        {
                            linkElment.innerHTML = "{/literal}{#str_LabelHideDetails#}{literal}";
                        }
                        else
                        {
                            linkElment.innerHTML = "{/literal}{#str_LabelHideOptions#}{literal}";
                        }
                    }
                    else
                    {
                        ...
                        if (pIsFooter)
                        {
                            linkElment.innerHTML = "{/literal}{#str_LabelShowDetails#}{literal}";
                        }
                        else
                        {
                            linkElment.innerHTML = "{/literal}{#str_LabelShowOptions#}{literal}";
                        }
                    }
                }
            ...
            <div id="contentBlocSite" class="contentBlocSite">
                ...
                <div id="contentAjaxQty" class="slideAnimation">
                    ...
                    {if $stage == 'qty'}
                        ...
                        {include file="order/jobticketajax_small.tpl"}
