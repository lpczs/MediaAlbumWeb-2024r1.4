<?php
/* Smarty version 4.5.3, created on 2026-03-06 05:12:41
  from 'C:\TAOPIX\MediaAlbumWeb\templates\order\jobticket_large.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69aa62492c0e82_41541491',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '279988a41b5d8c040e89dbb7a9ba0c2a50843c6a' => 
    array (
      0 => 'C:\\TAOPIX\\MediaAlbumWeb\\templates\\order\\jobticket_large.tpl',
      1 => 1729602708,
      2 => 'file',
    ),
  ),
...
function content_69aa62492c0e82_41541491 (Smarty_Internal_Template $_smarty_tpl) {
		...
		window.addEventListener('DOMContentLoaded', function(e)
		{
			...
			*/
			...
			for (var i = 0; i < productPreviewElementsLength; i++)
			{
				...
				{
					projectThumbnail.addEventListener('error', fallbackHandler);
				}
			}
		});
...
";
        ...
        function shippingMethodCfsClick(code, script, removeStore, pCallback, fromSelectStore = false)
        {
			gChangeMethodInPorgress = true;
...
";
            ...
            //remove address if not a fixed store
            if ((removeStore) && (gStoreFixed[code] != '1'))
            {
                storeaddress = '';
            }
...
"/>
                ...
                <input type="hidden" name="shippingcfscontact" value="0"/>
