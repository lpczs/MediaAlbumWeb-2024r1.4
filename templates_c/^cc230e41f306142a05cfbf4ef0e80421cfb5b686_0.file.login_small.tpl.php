<?php
/* Smarty version 4.5.3, created on 2026-04-22 07:50:33
  from 'C:\TAOPIX\MediaAlbumWeb\templates\login_small.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69e87dc975d381_60373887',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cc230e41f306142a05cfbf4ef0e80421cfb5b686' => 
    array (
      0 => 'C:\\TAOPIX\\MediaAlbumWeb\\templates\\login_small.tpl',
      1 => 1729602708,
      2 => 'file',
    ),
  ),
...
function content_69e87dc975d381_60373887 (Smarty_Internal_Template $_smarty_tpl) {
...
>
            ...
            */
            function changeSystemLanguageSmallScreen(pLanguageCode)
            {
                ...
                document.submitform.fsaction.value = "<?php echo $_smarty_tpl->tpl_vars['changelanguageinitfsaction']->value;?>
";
...
";
                ...
                {
                    message += "<br /><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'str_ErrorNoUserName');?>
";
                ...
                {
                    message += "<br /><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'str_ErrorNoPassword');?>
";
...
", message, function(e) {
                ...
                else
                {
                    ...
                    submitForm.fsaction.value = "<?php echo $_smarty_tpl->tpl_vars['loginfsaction']->value;?>
";
                    submitForm.format.value = format;
                    submitForm.prtz.value = '<?php echo $_smarty_tpl->tpl_vars['prtz']->value;?>
';
                    submitForm.mawebhluid.value = '<?php echo $_smarty_tpl->tpl_vars['mawebhluid']->value;?>
';
                    submitForm.mawebhlbr.value = '<?php echo $_smarty_tpl->tpl_vars['mawebhlbr']->value;?>
';
                    submitForm.fhlbu.value = '<?php echo $_smarty_tpl->tpl_vars['fhlbu']->value;?>
';
...
", jsonObj.error, function(e) {
                                ...
                                case 'createaccount':
                                    ...
                                    toggleJs('includeNewAccountJS', jsonObj.javascript, true, '', '<?php echo $_smarty_tpl->tpl_vars['nonceraw']->value;?>
');
...
';
            ...
            function showForgotPassword()
            {
                ...
                // send the ajax
                processAjaxSmallScreen('forgotpassword',".?fsaction=Welcome.initForgotPassword&ref=<?php echo $_smarty_tpl->tpl_vars['ref']->value;?>
", 'POST', postParams);
            }
...
", message, function(e) {
                ...
                else
                {
                    ...
                    // send the ajax
                    processAjaxSmallScreen("forgotpasswordsubmit",".?fsaction=Welcome.resetPasswordRequest&mobile=true&ref=<?php echo $_smarty_tpl->tpl_vars['session']->value;?>
", 'POST', postParams);
            ...
            function showNewAccount()
            {
                ...
                <?php if ($_smarty_tpl->tpl_vars['ishighlevel']->value == 1) {?>
            		postParam += "&groupcode=<?php echo $_smarty_tpl->tpl_vars['groupcode_script']->value;?>
";
            	<?php }?>

            		postParam += "&prtz=<?php echo $_smarty_tpl->tpl_vars['prtz']->value;?>
";
            		postParam += "&mawebhluid=<?php echo $_smarty_tpl->tpl_vars['mawebhluid']->value;?>
";
            		postParam += "&mawebhlbr=<?php echo $_smarty_tpl->tpl_vars['mawebhlbr']->value;?>
";
            		postParam += "&ishighlevel=<?php echo $_smarty_tpl->tpl_vars['ishighlevel']->value;?>
";
            		postParam += "&registerfsaction=<?php echo $_smarty_tpl->tpl_vars['registerfsaction']->value;?>
";
            		postParam += "&fromregisterlink=<?php echo $_smarty_tpl->tpl_vars['fromregisterlink']->value;?>
";
                    postParam += '&csrf_token=' + csrfToken;


                // send the ajax
                processAjaxSmallScreen('createaccount',".?fsaction=Welcome.initNewAccount&ref=<?php echo $_smarty_tpl->tpl_vars['ref']->value;?>
", 'POST', postParam);
            }
                            ...
                            <div id="contentHolder">
                                ...
                                <div id="blocSignIn" class="outerBox outerBoxPadding">
                                    ...
                                    <div>
                                        ...
                                        <div class="formLine1">
                                            <label for="login2small"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'str_LabelEmailorUsername');?>
:</label>
...
/images/asterisk.png" alt="*"/>
                                        ...
                                        <div class="formLine2">
                                            <input type="text" id="login2small" name="login2small" value="<?php echo $_smarty_tpl->tpl_vars['loginVal']->value;?>
" class="middle" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />
                                    ...
                                    <div class="top_gap">
                                        ...
                                        <div class="formLine1">
                                            <label for="password2small"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'str_LabelPassword');?>
:</label>
                                            <img class="valign-center" src="<?php echo $_smarty_tpl->tpl_vars['brandroot']->value;?>
/images/asterisk.png" alt="*"/>
                                        </div>
                                 ...
                                 <div class="signInBtn" data-decorator="fnValidateLoginSmallScreen">
                                    ...
                                    <div class="btnAction btnContinue">
                                        <div class="btnContinueContent"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'str_ButtonSignIn');?>
</div>
                                    </div>
